  ...
  return (
    <div className="container" style={{ maxWidth: "600px", marginTop: "2rem" }}>
      ...
      <div className="card mb-6">
        <h2 className="font-bold mb-4 border-b pb-2" style={{ borderColor: "var(--border-color)" }}>Meus Dados</h2>
        <div style={{ display: "grid", gap: "1rem" }}>
          <div>
            <label className="text-muted font-bold" style={{ fontSize: "0.85rem" }}>Nome da Franquia / Responsável</label>
            <p style={{ fontWeight: 500, fontSize: "1.1rem" }}>{user.name}</p>
          </div>
          <div>
            <label className="text-muted font-bold" style={{ fontSize: "0.85rem" }}>E-mail (Login)</label>
            <p style={{ fontWeight: 500 }}>{user.email}</p>
          </div>
          <div>
            <label className="text-muted font-bold" style={{ fontSize: "0.85rem" }}>Cidade / Rota</label>
            <p style={{ fontWeight: 500 }}>{user.city || "Não informada"}</p>
          </div>
          <div>
            <label className="text-muted font-bold" style={{ fontSize: "0.85rem" }}>CNPJ / CPF</label>
            <p style={{ fontWeight: 500 }}>{user.cpfCnpj || "Não informado"}</p>
          </div>
        </div>
      </div>
